...
<main class="min-h-screen bg-gradient-to-br from-neutral-50 to-neutral-100 p-8 space-y-8">
	<!-- Header Section -->
	<header
				...
				<table class="w-full">
					<thead>
						<tr class="bg-gradient-to-r from-primary-50 to-primary-100">
							...
							<th class="px-6 py-4 text-left text-sm font-semibold text-primary-700">Explanation</th
							>
						</tr>
					</thead>
					<tbody>
